  ...
  return (
    <div className='flex flex-col mt-20 h-[70vh] border-b-[1px] border-neutral-900 '>
        <div className='mx-auto w-[90%]  sm:border-dashed border-0 lg:w-4/5'>
            ...
            <h1 className='mx-auto w-[100%] lg:w-[80%] text-neutral-300 text-center p-0 m-0 font-extrabold border-b-[1px] border-dashed border-neutral-700 text-6xl md:text-7xl lg:text-[7vw] '>The Dev of the Web</h1>
